...
Проверяются центральный удар, острый угол, симметрия сторон, удар рядом
с линией ворот, а также отсутствие отрицательных значений и NaN
при валидных координатах.
"""
