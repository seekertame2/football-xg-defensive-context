"""Тесты геометрии удара (спецификация, разделы 9.1 и 17).

Проверяются случаи, явно перечисленные в спецификации: центральный удар,
острый угол, симметрия сторон, удар рядом с линией ворот, а также
...
class TestGoalkeeperGeometry:
    ...
    def test_missing_keeper_gives_nan_not_a_guess(self) -> None:
        """Координаты вратаря нельзя придумывать (спецификация, раздел 9.5)."""
