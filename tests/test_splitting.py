...
Главное правило: удары одного матча не могут попадать в разные части
выборки. Дополнительно проверяются детерминированность, сопоставимые доли
лиг и сопоставимая доля голов.
"""
