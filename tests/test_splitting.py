"""Тесты группового разбиения выборки (спецификация, разделы 10.1 и 17).

Проверяется главное правило эксперимента: удары одного матча не могут
попадать в разные части выборки. Дополнительно — детерминированность,
сопоставимые доли лиг и сопоставимая доля голов, чего требует решение
владельца проекта от 2026-08-23.
"""
...
class TestBalance:
    """Решение владельца: доли лиг и доля голов должны быть сопоставимы."""
