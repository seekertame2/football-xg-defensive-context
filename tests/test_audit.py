"""Тесты разбора ударов для аудита (спецификация, раздел 6).

Проверяется на синтетических событиях в схеме StatsBomb: сеть не нужна.
Главное требование — аудит честно отличает «контекст есть» от
«freeze_frame формально присутствует, но координат соперников нет».
"""
