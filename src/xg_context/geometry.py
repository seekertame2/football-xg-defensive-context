...
Все функции чистые и векторизованные по NumPy, поэтому их можно покрыть
тестами и переиспользовать в ноутбуках без дублирования логики.
...
# Функции ниже работают с координатами соперников одного удара. `freeze_frame`
# показывает только игроков, попавших в кадр, поэтому любой счётчик здесь
# означает «сколько соперников видно», а не «сколько их на поле».
